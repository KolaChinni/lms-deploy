                  ...
                  <div className="dropdown-menu">
                    ...
                    >
                      ...
                      <span className="dropdown-text">
                        ...
                        <small>Add video lessons via Cloudinary</small>
                      </span>
                    </button>
                    <button 
                      className="dropdown-item"
                      onClick={handleAddOtherContent}
                    >
                      <span className="dropdown-icon">📄</span>
                      <span className="dropdown-text">
                        <strong>Add Other Content</strong>
                        <small>Documents, quizzes, and more</small>
                      </span>
                    </button>
                  </div>
                )}
        ...
        <div className="tab-content">
          {activeTab === 'overview' && (
            <OverviewTab 
              ...
              onAddOtherContent={handleAddOtherContent}
...
// Updated OverviewTab with merged buttons
const OverviewTab = ({ course, content, assignments, enrollments, onUploadVideo, onAddOtherContent, onCreateAssignment }) => {
      ...
      <div className="overview-grid">
        ...
        <div className="quick-actions-card">
          ...
          <div className="action-buttons">
            ...
            <button className="action-btn success" onClick={onAddOtherContent}>
              <span className="action-icon">📚</span>
...
// Updated ContentTab with merged buttons
const ContentTab = ({ content, onUploadVideo, onAddOtherContent, onDeleteVideo }) => {
    ...
    <div className="content-tab">
      <div className="tab-header">
        ...
        <div className="content-action-buttons">
          ...
          <button className="btn btn-secondary" onClick={onAddOtherContent}>
            Add Other Content
          </button>
        </div>
      </div>
      ...
      {content.length === 0 ? (
        <div className="empty-state">
          ...
          <div className="empty-state-actions">
            ...
            <button className="btn btn-outline" onClick={onAddOtherContent}>
              Add Other Content
            </button>
          </div>
        </div>
...
// ... (rest of the components remain the same - ContentItem, VideoItem, AssignmentsTab, AssignmentItem, StudentsTab)
